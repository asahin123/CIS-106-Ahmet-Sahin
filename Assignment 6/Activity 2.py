...
def displayResult(age, years, months, days, hours, seconds):
    print(str(age) + "Age is " + str(years) + "Years " + str(months) + "Months " + str(days) + "Days " + str(hours) + "Hours " + str(seconds) + "Seconds ")
...
displayResult(age, years, months, days, hours, seconds)
